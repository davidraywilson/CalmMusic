package com.calmapps.calmtunes.playback
 ...
 * playback queue. This is extracted from MainActivity/CalmTunes to reduce the
...
class PlaybackCoordinator {
     ...
     * queue. Logic is copied from the original CalmTunes implementation.
     */
