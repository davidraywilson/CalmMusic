...
import com.calmapps.calmtunes.data.CalmTunesSettingsManager
import com.calmapps.calmtunes.data.NowPlayingStorage
import com.calmapps.calmtunes.data.PlaybackStateManager
import com.calmapps.calmtunes.overlay.SystemOverlayService
import okhttp3.OkHttpClient
import java.io.File

@UnstableApi
class CalmTunes : Application(), DefaultLifecycleObserver {
    ...
    lateinit var settingsManager: CalmTunesSettingsManager
        private set
    ...
    override fun onCreate() {
        ...
        settingsManager = CalmTunesSettingsManager(this)
