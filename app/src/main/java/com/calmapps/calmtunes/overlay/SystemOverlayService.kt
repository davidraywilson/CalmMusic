package com.calmapps.calmtunes.overlay
...
import com.calmapps.calmtunes.MainActivity
import com.calmapps.calmtunes.PlaybackService
...
class SystemOverlayService : Service() {
    ...
    override fun onCreate() {
        ...
        playbackStateManager = (application as CalmTunes).playbackStateManager
    ...
    private fun stopPlayback() {
        val app = application as? CalmTunes
