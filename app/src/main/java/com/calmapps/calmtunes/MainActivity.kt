...
import com.calmapps.calmtunes.data.StreamingProvider
import com.calmapps.calmtunes.overlay.SystemOverlayService
import com.calmapps.calmtunes.ui.AlbumDetailsScreen
import com.calmapps.calmtunes.ui.AlbumUiModel
import com.calmapps.calmtunes.ui.AlbumsScreen
import com.calmapps.calmtunes.ui.ArtistDetailsScreen
import com.calmapps.calmtunes.ui.ArtistsScreen
import com.calmapps.calmtunes.ui.DownloadsScreen
import com.calmapps.calmtunes.ui.MoreScreen
import com.calmapps.calmtunes.ui.NowPlayingScreen
import com.calmapps.calmtunes.ui.PermissionsOnboardingScreen
import com.calmapps.calmtunes.ui.PlaylistAddSongsScreen
import com.calmapps.calmtunes.ui.PlaylistDetailsScreen
import com.calmapps.calmtunes.ui.PlaylistEditScreen
import com.calmapps.calmtunes.ui.PlaylistItem
import com.calmapps.calmtunes.ui.PlaylistUiModel
import com.calmapps.calmtunes.ui.PlaylistsScreen
import com.calmapps.calmtunes.ui.RadioScreen
import com.calmapps.calmtunes.ui.SearchScreen
import com.calmapps.calmtunes.ui.SettingsScreen
import com.calmapps.calmtunes.ui.SongUiModel
import com.calmapps.calmtunes.ui.SongsScreen
...
fun CalmTunes(app: CalmTunes) {
    ...
    val viewModel: CalmTunesViewModel = viewModel(factory = CalmTunesViewModel.factory(app))
    ...
    fun startPlaybackFromQueue(
        ...
        val needsLocalController = song.sourceType == SourceType.LOCAL_FILE || song.sourceType == SourceType.YOUTUBE || song.sourceType == SourceType.YOUTUBE_DOWNLOAD
    ...
    val onDelete: (SongUiModel) -> Unit = { song ->
        libraryScope.launch {
            when (song.sourceType) {
                ...
                SourceType.LOCAL_FILE, SourceType.YOUTUBE_DOWNLOAD -> {
                    val success = try {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        if (showNowPlaying && playbackState.nowPlayingSong != null) {
            ...
            val isLocalVideo = if (song.sourceType == SourceType.LOCAL_FILE || song.sourceType == SourceType.YOUTUBE_DOWNLOAD) {
            ...
            NowPlayingScreen(
                title = song.title,
                artist = song.artist.ifBlank { if (song.sourceType == SourceType.LOCAL_FILE || song.sourceType == SourceType.YOUTUBE_DOWNLOAD) "Local file" else "" },
                album = song.album,
                ...
                onSeek = { positionMs ->
                    when (song.sourceType) {
                        SourceType.LOCAL_FILE, SourceType.YOUTUBE, SourceType.YOUTUBE_DOWNLOAD -> {
                ...
                canDownload = (streamingProvider == StreamingProvider.YOUTUBE && song.sourceType == SourceType.YOUTUBE),
                ...
                canAddToLibrary = (streamingProvider == StreamingProvider.YOUTUBE && song.sourceType == SourceType.YOUTUBE && !isInLibrary),
                onAddToLibraryClick = {
                    libraryScope.launch {
                        try {
                            viewModel.addStreamingSongToLibrary(song)
                ...
                streamResolverLabel = if (song.sourceType == SourceType.YOUTUBE) overlayState.streamResolverLabel else null,
            )
        }
